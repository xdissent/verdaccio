...
module.exports = function (config, auth, storage) {
  ...
  router.get('/', function (req, res) {
    ...
    let webPage = template.replace(/ToReplaceByVerdaccio/g, base).replace(/ToReplaceByTitle/g, _lodash2.default.get(config, 'web.title') ? config.web.title : defaultTitle).replace(/(main.*\.js|style.*\.css)/g, `${base}/-/static/$1`);
